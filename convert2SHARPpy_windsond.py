...
#===============================================================================================================
#
#  Python script to convert MSU windsonde sounding files to SHARPpy format
#
#===============================================================================================================
...
myhelp = """\n
            ...
            python convert2SHARPpy_MSU.py --filename 2016-03-13_1901.raw.csv --stationID MSU
...
pres=DAT[:,1]/100      # pressure (mb)
tc=DAT[:,4]            # temperature (C)
rh=DAT[:,5]            # relative humidity (%)
wspd=DAT[:,2]*1.94384  # wind speed (knots)
wdir=DAT[:,3]+180      # wind direction (deg)
hght=DAT[:,0]          # height (MSL)
...
# open output file
fout = open(year + month + day + time + "_MSU_SHARPpy", "wt")
